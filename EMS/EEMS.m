function [sys,x0,str,ts,simStateCompliance] = EEMS(t,x,u,flag)
...
%=============================================================================
%
function sys=mdlOutputs(t,x,u) %#ok<*INUSL>
...
[y,fval] = fmincon(@eemsfun,x0,A,b,[],[],lb,ub,[],options); %#ok<*ASGLU>
Pbatt=y(1); DV=y(2);
sys = [Pbatt DV];
