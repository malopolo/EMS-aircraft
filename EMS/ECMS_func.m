function [sys,x0,str,ts,simStateCompliance] = ECMS(t,x,u,flag)
...
% [alpha_p; Pload]
% mu = SOC balance coeff (0.6 usually)
mu=0.6;
...
% The anonymous function ecmsfun -> 
% F(X) = [Pfc + alpha_p * Pbatt]*delta_T
[y,fval] = fmincon(@ecmsfun,x0,[],[],Aeq,beq,lb,ub,[],options); %#ok<*ASGLU>
