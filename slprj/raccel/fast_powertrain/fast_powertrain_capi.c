...
"fast_powertrain/Abs2" ) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 0 } , { 1 ,
0 , TARGET_STRING ( "fast_powertrain/Constant1" ) , TARGET_STRING ( "" ) , 0
, 0 , 0 , 0 , 0 } , { 2 , 0 , TARGET_STRING ( "fast_powertrain/Constant2" ) ,
TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 0 } , { 3 , 0 , TARGET_STRING (
"fast_powertrain/Constant3" ) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 0 } ,
{ 4 , 0 , TARGET_STRING ( "fast_powertrain/Multiply" ) , TARGET_STRING ( "" )
, 0 , 0 , 0 , 0 , 1 } , { 5 , 0 , TARGET_STRING ( "fast_powertrain/Multiply1"
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 6 , 0 , TARGET_STRING (
"fast_powertrain/Multiply3" ) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } ,
{ 7 , 0 , TARGET_STRING ( "fast_powertrain/Square" ) , TARGET_STRING ( "" ) ,
0 , 0 , 0 , 0 , 0 } , { 8 , 0 , TARGET_STRING ( "fast_powertrain/Square1" ) ,
TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 1 } , { 9 , 0 , TARGET_STRING (
"fast_powertrain/Square2" ) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , {
10 , 0 , TARGET_STRING ( "fast_powertrain/Product" ) , TARGET_STRING ( "" ) ,
0 , 0 , 0 , 0 , 2 } , { 11 , 0 , TARGET_STRING ( "fast_powertrain/Product21"
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 12 , 11 , TARGET_STRING (
"fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/MATLAB Function5" )
, TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 13 , 11 , TARGET_STRING (
"fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/MATLAB Function5" )
, TARGET_STRING ( "" ) , 1 , 0 , 0 , 0 , 2 } , { 14 , 0 , TARGET_STRING (
...
, 0 , 0 , 0 , 2 } , { 22 , 0 , TARGET_STRING (
"fast_powertrain/Boost FC - fast/Fcn" ) , TARGET_STRING ( "" ) , 0 , 0 , 0 ,
0 , 2 } , { 23 , 0 , TARGET_STRING ( "fast_powertrain/Boost FC - fast/Fcn1" )
, TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 24 , 0 , TARGET_STRING (
"fast_powertrain/Boost FC - fast/Product" ) , TARGET_STRING ( "" ) , 0 , 0 ,
0 , 0 , 2 } , { 25 , 0 , TARGET_STRING (
"fast_powertrain/Boost FC - fast/Sum" ) , TARGET_STRING ( "" ) , 0 , 0 , 0 ,
0 , 1 } , { 26 , 0 , TARGET_STRING ( "fast_powertrain/Boost FC - fast/Sum3" )
, TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 1 } , { 27 , 0 , TARGET_STRING (
"fast_powertrain/Boost FC - fast/Unit Delay2" ) , TARGET_STRING ( "" ) , 0 ,
0 , 0 , 0 , 2 } , { 28 , 0 , TARGET_STRING (
...
"fast_powertrain/Battery/Model/Gain2" ) , TARGET_STRING ( "" ) , 0 , 0 , 0 ,
0 , 2 } , { 37 , 0 , TARGET_STRING ( "fast_powertrain/Battery/Model/R1" ) ,
...
"fast_powertrain/Boost FC - fast/Saturation Dynamic/Switch" ) , TARGET_STRING
( "" ) , 0 , 0 , 0 , 0 , 2 } , { 48 , 0 , TARGET_STRING (
"fast_powertrain/Boost FC - fast/Voltage Measurement/do not delete this gain"
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 49 , 0 , TARGET_STRING (
...
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 52 , 0 , TARGET_STRING (
...
"" ) , 0 , 0 , 1 , 0 , 2 } , { 55 , 0 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"" ) , 1 , 0 , 2 , 0 , 2 } , { 56 , 0 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"" ) , 2 , 0 , 0 , 0 , 2 } , { 57 , 0 , TARGET_STRING (
...
"" ) , 0 , 0 , 0 , 0 , 2 } , { 59 , 2 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/DOD and average current calculation Block"
) , TARGET_STRING ( "" ) , 3 , 0 , 0 , 0 , 2 } , { 60 , 2 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/DOD and average current calculation Block"
) , TARGET_STRING ( "" ) , 4 , 0 , 0 , 0 , 2 } , { 61 , 2 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/DOD and average current calculation Block"
) , TARGET_STRING ( "" ) , 5 , 0 , 0 , 0 , 2 } , { 62 , 2 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/DOD and average current calculation Block"
) , TARGET_STRING ( "" ) , 6 , 0 , 0 , 0 , 2 } , { 63 , 2 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/DOD and average current calculation Block"
) , TARGET_STRING ( "" ) , 7 , 0 , 0 , 0 , 2 } , { 64 , 2 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/DOD and average current calculation Block"
) , TARGET_STRING ( "" ) , 8 , 0 , 0 , 0 , 2 } , { 65 , 2 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/DOD and average current calculation Block"
) , TARGET_STRING ( "" ) , 9 , 0 , 0 , 0 , 2 } , { 66 , 2 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/DOD and average current calculation Block"
) , TARGET_STRING ( "" ) , 10 , 0 , 0 , 0 , 2 } , { 67 , 2 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/DOD and average current calculation Block"
) , TARGET_STRING ( "" ) , 11 , 0 , 0 , 0 , 2 } , { 68 , 2 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/DOD and average current calculation Block"
) , TARGET_STRING ( "" ) , 12 , 0 , 0 , 0 , 2 } , { 69 , 2 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/DOD and average current calculation Block"
) , TARGET_STRING ( "" ) , 13 , 0 , 0 , 0 , 2 } , { 70 , 2 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/DOD and average current calculation Block"
) , TARGET_STRING ( "" ) , 14 , 0 , 0 , 0 , 2 } , { 71 , 2 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/DOD and average current calculation Block"
) , TARGET_STRING ( "" ) , 15 , 0 , 0 , 0 , 2 } , { 72 , 2 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/DOD and average current calculation Block"
) , TARGET_STRING ( "" ) , 16 , 0 , 0 , 0 , 2 } , { 73 , 2 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/DOD and average current calculation Block"
) , TARGET_STRING ( "" ) , 17 , 0 , 0 , 0 , 2 } , { 74 , 2 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/DOD and average current calculation Block"
) , TARGET_STRING ( "" ) , 18 , 0 , 0 , 0 , 2 } , { 75 , 2 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/DOD and average current calculation Block"
) , TARGET_STRING ( "" ) , 19 , 0 , 0 , 0 , 2 } , { 76 , 2 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/DOD and average current calculation Block"
) , TARGET_STRING ( "" ) , 20 , 0 , 0 , 0 , 2 } , { 77 , 0 , TARGET_STRING (
"fast_powertrain/Battery/Model/Exp/Gain1" ) , TARGET_STRING ( "" ) , 0 , 0 ,
0 , 0 , 2 } , { 78 , 0 , TARGET_STRING (
...
TARGET_STRING ( "" ) , 0 , 0 , 2 , 0 , 0 } , { 82 , 1 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/Aging factor Calculation Block/MATLAB Function1"
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 83 , 1 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/Aging factor Calculation Block/MATLAB Function1"
) , TARGET_STRING ( "" ) , 1 , 0 , 0 , 0 , 2 } , { 84 , 1 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/Aging factor Calculation Block/MATLAB Function1"
) , TARGET_STRING ( "" ) , 2 , 0 , 0 , 0 , 2 } , { 85 , 0 , TARGET_STRING (
...
rtBlockParameters [ ] = { { 92 , TARGET_STRING ( "fast_powertrain/Battery" )
, TARGET_STRING ( "BatType" ) , 0 , 0 , 0 } , { 93 , TARGET_STRING (
"fast_powertrain/Battery" ) , TARGET_STRING ( "SOC" ) , 0 , 0 , 0 } , { 94 ,
TARGET_STRING ( "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast" ) ,
TARGET_STRING ( "n_buck" ) , 0 , 0 , 0 } , { 95 , TARGET_STRING (
"fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast" ) , TARGET_STRING (
"n_boost" ) , 0 , 0 , 0 } , { 96 , TARGET_STRING (
"fast_powertrain/Boost - PV - fast" ) , TARGET_STRING ( "n" ) , 0 , 0 , 0 } ,
{ 97 , TARGET_STRING ( "fast_powertrain/Boost FC - fast" ) , TARGET_STRING (
"n" ) , 0 , 0 , 0 } , { 98 , TARGET_STRING (
"fast_powertrain/Discrete PI Controller2" ) , TARGET_STRING ( "Kp" ) , 0 , 0
, 0 } , { 99 , TARGET_STRING ( "fast_powertrain/Discrete PI Controller2" ) ,
TARGET_STRING ( "Ki" ) , 0 , 0 , 0 } , { 100 , TARGET_STRING (
"fast_powertrain/Discrete PI Controller2" ) , TARGET_STRING ( "Init" ) , 0 ,
0 , 0 } , { 101 , TARGET_STRING ( "fast_powertrain/PV MODULE1" ) ,
TARGET_STRING ( "Npar" ) , 0 , 0 , 0 } , { 102 , TARGET_STRING (
"fast_powertrain/PV MODULE1" ) , TARGET_STRING ( "Nser" ) , 0 , 0 , 0 } , {
103 , TARGET_STRING ( "fast_powertrain/PV MODULE1" ) , TARGET_STRING (
"Ncell" ) , 0 , 0 , 0 } , { 104 , TARGET_STRING (
"fast_powertrain/PV MODULE1" ) , TARGET_STRING ( "Voc" ) , 0 , 0 , 0 } , {
105 , TARGET_STRING ( "fast_powertrain/PV MODULE1" ) , TARGET_STRING ( "Isc"
) , 0 , 0 , 0 } , { 106 , TARGET_STRING ( "fast_powertrain/PV MODULE1" ) ,
TARGET_STRING ( "Vmpp" ) , 0 , 0 , 0 } , { 107 , TARGET_STRING (
"fast_powertrain/PV MODULE1" ) , TARGET_STRING ( "Impp" ) , 0 , 0 , 0 } , {
108 , TARGET_STRING ( "fast_powertrain/PV MODULE1" ) , TARGET_STRING (
"beta_Voc" ) , 0 , 0 , 0 } , { 109 , TARGET_STRING (
"fast_powertrain/PV MODULE1" ) , TARGET_STRING ( "I0" ) , 0 , 0 , 0 } , { 110
, TARGET_STRING ( "fast_powertrain/PV MODULE1" ) , TARGET_STRING ( "df" ) , 0
, 0 , 0 } , { 111 , TARGET_STRING ( "fast_powertrain/PV MODULE1" ) ,
TARGET_STRING ( "Rsh" ) , 0 , 0 , 0 } , { 112 , TARGET_STRING (
"fast_powertrain/PV MODULE1" ) , TARGET_STRING ( "Rs" ) , 0 , 0 , 0 } , { 113
, TARGET_STRING ( "fast_powertrain/Variable Resistor" ) , TARGET_STRING (
"Rabsmin" ) , 0 , 0 , 0 } , { 114 , TARGET_STRING (
"fast_powertrain/Constant" ) , TARGET_STRING ( "Value" ) , 0 , 0 , 0 } , {
115 , TARGET_STRING ( "fast_powertrain/Constant1" ) , TARGET_STRING ( "Value"
) , 0 , 0 , 0 } , { 116 , TARGET_STRING ( "fast_powertrain/Constant10" ) ,
TARGET_STRING ( "Value" ) , 0 , 0 , 0 } , { 117 , TARGET_STRING (
"fast_powertrain/Constant2" ) , TARGET_STRING ( "Value" ) , 0 , 0 , 0 } , {
118 , TARGET_STRING ( "fast_powertrain/Constant3" ) , TARGET_STRING ( "Value"
) , 0 , 0 , 0 } , { 119 , TARGET_STRING ( "fast_powertrain/Constant4" ) ,
TARGET_STRING ( "Value" ) , 0 , 0 , 0 } , { 120 , TARGET_STRING (
"fast_powertrain/Constant6" ) , TARGET_STRING ( "Value" ) , 0 , 0 , 0 } , {
121 , TARGET_STRING ( "fast_powertrain/Constant7" ) , TARGET_STRING ( "Value"
) , 0 , 0 , 0 } , { 122 , TARGET_STRING ( "fast_powertrain/Constant8" ) ,
TARGET_STRING ( "Value" ) , 0 , 0 , 0 } , { 123 , TARGET_STRING (
"fast_powertrain/Constant9" ) , TARGET_STRING ( "Value" ) , 0 , 0 , 0 } , {
124 , TARGET_STRING ( "fast_powertrain/Multiply" ) , TARGET_STRING ( "Gain" )
, 0 , 0 , 0 } , { 125 , TARGET_STRING ( "fast_powertrain/Multiply1" ) ,
TARGET_STRING ( "Gain" ) , 0 , 0 , 0 } , { 126 , TARGET_STRING (
"fast_powertrain/Multiply2" ) , TARGET_STRING ( "Gain" ) , 0 , 0 , 0 } , {
127 , TARGET_STRING ( "fast_powertrain/Multiply3" ) , TARGET_STRING ( "Gain"
) , 0 , 0 , 0 } , { 128 , TARGET_STRING ( "fast_powertrain/Battery/Ta" ) ,
TARGET_STRING ( "Value" ) , 0 , 0 , 0 } , { 129 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller1"
) , TARGET_STRING ( "Kp" ) , 0 , 0 , 0 } , { 130 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller1"
) , TARGET_STRING ( "Ki" ) , 0 , 0 , 0 } , { 131 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller1"
) , TARGET_STRING ( "Init" ) , 0 , 0 , 0 } , { 132 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller2"
) , TARGET_STRING ( "Kp" ) , 0 , 0 , 0 } , { 133 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller2"
) , TARGET_STRING ( "Ki" ) , 0 , 0 , 0 } , { 134 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller2"
) , TARGET_STRING ( "Init" ) , 0 , 0 , 0 } , { 135 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller3"
) , TARGET_STRING ( "Kp" ) , 0 , 0 , 0 } , { 136 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller3"
) , TARGET_STRING ( "Ki" ) , 0 , 0 , 0 } , { 137 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller3"
) , TARGET_STRING ( "Init" ) , 0 , 0 , 0 } , { 138 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller4"
) , TARGET_STRING ( "Kp" ) , 0 , 0 , 0 } , { 139 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller4"
) , TARGET_STRING ( "Ki" ) , 0 , 0 , 0 } , { 140 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller4"
) , TARGET_STRING ( "Init" ) , 0 , 0 , 0 } , { 141 , TARGET_STRING (
...
TARGET_STRING ( "UpperLimit" ) , 0 , 0 , 0 } , { 147 , TARGET_STRING (
"fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Saturation" ) ,
TARGET_STRING ( "LowerLimit" ) , 0 , 0 , 0 } , { 148 , TARGET_STRING (
"fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Saturation1" ) ,
TARGET_STRING ( "UpperLimit" ) , 0 , 0 , 0 } , { 149 , TARGET_STRING (
"fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Saturation1" ) ,
TARGET_STRING ( "LowerLimit" ) , 0 , 0 , 0 } , { 150 , TARGET_STRING (
...
TARGET_STRING ( "UpperLimit" ) , 0 , 0 , 0 } , { 155 , TARGET_STRING (
"fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Saturation4" ) ,
TARGET_STRING ( "LowerLimit" ) , 0 , 0 , 0 } , { 156 , TARGET_STRING (
...
"fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Unit Delay1" ) ,
TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 161 , TARGET_STRING (
"fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Unit Delay2" ) ,
TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 162 , TARGET_STRING (
"fast_powertrain/Boost - PV - fast/Saturation1" ) , TARGET_STRING (
"UpperLimit" ) , 0 , 0 , 0 } , { 163 , TARGET_STRING (
"fast_powertrain/Boost - PV - fast/Saturation1" ) , TARGET_STRING (
"LowerLimit" ) , 0 , 0 , 0 } , { 164 , TARGET_STRING (
...
"Kp" ) , 0 , 0 , 0 } , { 168 , TARGET_STRING (
"fast_powertrain/Boost FC - fast/Discrete PI Controller3" ) , TARGET_STRING (
"Ki" ) , 0 , 0 , 0 } , { 169 , TARGET_STRING (
"fast_powertrain/Boost FC - fast/Discrete PI Controller3" ) , TARGET_STRING (
"Init" ) , 0 , 0 , 0 } , { 170 , TARGET_STRING (
"fast_powertrain/Boost FC - fast/Discrete PI Controller4" ) , TARGET_STRING (
"Kp" ) , 0 , 0 , 0 } , { 171 , TARGET_STRING (
"fast_powertrain/Boost FC - fast/Discrete PI Controller4" ) , TARGET_STRING (
"Ki" ) , 0 , 0 , 0 } , { 172 , TARGET_STRING (
"fast_powertrain/Boost FC - fast/Discrete PI Controller4" ) , TARGET_STRING (
"Init" ) , 0 , 0 , 0 } , { 173 , TARGET_STRING (
"fast_powertrain/Boost FC - fast/Constant" ) , TARGET_STRING ( "Value" ) , 0
, 0 , 0 } , { 174 , TARGET_STRING (
...
"InitialCondition" ) , 0 , 0 , 0 } , { 182 , TARGET_STRING (
...
"fast_powertrain/Current Measurement2/do not delete this gain" ) ,
...
"fast_powertrain/Discrete PI Controller2/Discrete-Time Integrator" ) ,
TARGET_STRING ( "UpperSaturationLimit" ) , 0 , 0 , 0 } , { 187 ,
TARGET_STRING (
"fast_powertrain/Discrete PI Controller2/Discrete-Time Integrator" ) ,
TARGET_STRING ( "LowerSaturationLimit" ) , 0 , 0 , 0 } , { 188 ,
TARGET_STRING ( "fast_powertrain/Discrete PI Controller2/Saturation2" ) ,
TARGET_STRING ( "UpperLimit" ) , 0 , 0 , 0 } , { 189 , TARGET_STRING (
...
, 0 , 0 } , { 192 , TARGET_STRING (
"fast_powertrain/PEMFC matfunc V2/Discrete-Time Integrator" ) , TARGET_STRING
( "gainval" ) , 0 , 0 , 0 } , { 193 , TARGET_STRING (
"fast_powertrain/PEMFC matfunc V2/Discrete-Time Integrator" ) , TARGET_STRING
( "InitialCondition" ) , 0 , 0 , 0 } , { 194 , TARGET_STRING (
...
"InitialCondition" ) , 0 , 0 , 0 } , { 198 , TARGET_STRING (
...
, 0 } , { 201 , TARGET_STRING ( "fast_powertrain/PV MODULE1/Unit Delay1" ) ,
TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 202 , TARGET_STRING (
...
0 , 0 } , { 206 , TARGET_STRING ( "fast_powertrain/Battery/Model/Constant1" )
...
, 0 , 0 } , { 209 , TARGET_STRING ( "fast_powertrain/Battery/Model/Constant8"
) , TARGET_STRING ( "Value" ) , 0 , 0 , 0 } , { 210 , TARGET_STRING (
"fast_powertrain/Battery/Model/Constant9" ) , TARGET_STRING ( "Value" ) , 0 ,
0 , 0 } , { 211 , TARGET_STRING ( "fast_powertrain/Battery/Model/int(i)" ) ,
TARGET_STRING ( "gainval" ) , 0 , 0 , 0 } , { 212 , TARGET_STRING (
"fast_powertrain/Battery/Model/int(i)" ) , TARGET_STRING (
"UpperSaturationLimit" ) , 0 , 0 , 0 } , { 213 , TARGET_STRING (
"fast_powertrain/Battery/Model/int(i)" ) , TARGET_STRING (
"LowerSaturationLimit" ) , 0 , 0 , 0 } , { 214 , TARGET_STRING (
"fast_powertrain/Battery/Model/Gain" ) , TARGET_STRING ( "Gain" ) , 0 , 0 , 0
} , { 215 , TARGET_STRING ( "fast_powertrain/Battery/Model/Gain2" ) ,
TARGET_STRING ( "Gain" ) , 0 , 0 , 0 } , { 216 , TARGET_STRING (
"fast_powertrain/Battery/Model/R1" ) , TARGET_STRING ( "Gain" ) , 0 , 0 , 0 }
, { 217 , TARGET_STRING ( "fast_powertrain/Battery/Model/R2" ) ,
TARGET_STRING ( "Gain" ) , 0 , 0 , 0 } , { 218 , TARGET_STRING (
"fast_powertrain/Battery/Model/R3" ) , TARGET_STRING ( "Gain" ) , 0 , 0 , 0 }
, { 219 , TARGET_STRING ( "fast_powertrain/Battery/Model/R4" ) ,
...
"Numerator" ) , 0 , 0 , 0 } , { 227 , TARGET_STRING (
"fast_powertrain/Battery/Model/Current filter5" ) , TARGET_STRING (
"Denominator" ) , 0 , 3 , 0 } , { 228 , TARGET_STRING (
"fast_powertrain/Battery/Model/Current filter5" ) , TARGET_STRING (
"InitialStates" ) , 0 , 0 , 0 } , { 229 , TARGET_STRING (
...
) , TARGET_STRING ( "gainval" ) , 0 , 0 , 0 } , { 233 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller1/Discrete-Time Integrator"
) , TARGET_STRING ( "UpperSaturationLimit" ) , 0 , 0 , 0 } , { 234 ,
TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller1/Discrete-Time Integrator"
) , TARGET_STRING ( "LowerSaturationLimit" ) , 0 , 0 , 0 } , { 235 ,
TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller1/Saturation2"
) , TARGET_STRING ( "UpperLimit" ) , 0 , 0 , 0 } , { 236 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller1/Saturation2"
) , TARGET_STRING ( "LowerLimit" ) , 0 , 0 , 0 } , { 237 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller2/Discrete-Time Integrator"
) , TARGET_STRING ( "gainval" ) , 0 , 0 , 0 } , { 238 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller2/Discrete-Time Integrator"
) , TARGET_STRING ( "UpperSaturationLimit" ) , 0 , 0 , 0 } , { 239 ,
TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller2/Discrete-Time Integrator"
) , TARGET_STRING ( "LowerSaturationLimit" ) , 0 , 0 , 0 } , { 240 ,
TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller2/Saturation2"
) , TARGET_STRING ( "UpperLimit" ) , 0 , 0 , 0 } , { 241 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller2/Saturation2"
) , TARGET_STRING ( "LowerLimit" ) , 0 , 0 , 0 } , { 242 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller3/Discrete-Time Integrator"
) , TARGET_STRING ( "gainval" ) , 0 , 0 , 0 } , { 243 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller3/Discrete-Time Integrator"
) , TARGET_STRING ( "UpperSaturationLimit" ) , 0 , 0 , 0 } , { 244 ,
TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller3/Discrete-Time Integrator"
) , TARGET_STRING ( "LowerSaturationLimit" ) , 0 , 0 , 0 } , { 245 ,
TARGET_STRING (
...
) , TARGET_STRING ( "gainval" ) , 0 , 0 , 0 } , { 248 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller4/Discrete-Time Integrator"
) , TARGET_STRING ( "UpperSaturationLimit" ) , 0 , 0 , 0 } , { 249 ,
TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller4/Discrete-Time Integrator"
) , TARGET_STRING ( "LowerSaturationLimit" ) , 0 , 0 , 0 } , { 250 ,
TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller4/Saturation2"
) , TARGET_STRING ( "UpperLimit" ) , 0 , 0 , 0 } , { 251 , TARGET_STRING (
 "fast_powertrain/Bidirectional BOOST//BUCK - Batt - fast/Discrete PI Controller4/Saturation2"
) , TARGET_STRING ( "LowerLimit" ) , 0 , 0 , 0 } , { 252 , TARGET_STRING (
...
) , TARGET_STRING ( "Gain" ) , 0 , 0 , 0 } , { 256 , TARGET_STRING (
...
) , TARGET_STRING ( "gainval" ) , 0 , 0 , 0 } , { 260 , TARGET_STRING (
 "fast_powertrain/Boost FC - fast/Discrete PI Controller3/Discrete-Time Integrator"
) , TARGET_STRING ( "UpperSaturationLimit" ) , 0 , 0 , 0 } , { 261 ,
TARGET_STRING (
 "fast_powertrain/Boost FC - fast/Discrete PI Controller3/Discrete-Time Integrator"
) , TARGET_STRING ( "LowerSaturationLimit" ) , 0 , 0 , 0 } , { 262 ,
TARGET_STRING (
"fast_powertrain/Boost FC - fast/Discrete PI Controller3/Saturation2" ) ,
TARGET_STRING ( "UpperLimit" ) , 0 , 0 , 0 } , { 263 , TARGET_STRING (
"fast_powertrain/Boost FC - fast/Discrete PI Controller3/Saturation2" ) ,
TARGET_STRING ( "LowerLimit" ) , 0 , 0 , 0 } , { 264 , TARGET_STRING (
 "fast_powertrain/Boost FC - fast/Discrete PI Controller4/Discrete-Time Integrator"
) , TARGET_STRING ( "gainval" ) , 0 , 0 , 0 } , { 265 , TARGET_STRING (
 "fast_powertrain/Boost FC - fast/Discrete PI Controller4/Discrete-Time Integrator"
) , TARGET_STRING ( "UpperSaturationLimit" ) , 0 , 0 , 0 } , { 266 ,
TARGET_STRING (
 "fast_powertrain/Boost FC - fast/Discrete PI Controller4/Discrete-Time Integrator"
) , TARGET_STRING ( "LowerSaturationLimit" ) , 0 , 0 , 0 } , { 267 ,
TARGET_STRING (
...
TARGET_STRING ( "Threshold" ) , 0 , 0 , 0 } , { 278 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P1" ) , 0 , 0 , 0 } , { 279 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P2" ) , 0 , 4 , 0 } , { 280 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P3" ) , 0 , 5 , 0 } , { 281 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P4" ) , 0 , 6 , 0 } , { 282 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P5" ) , 0 , 7 , 0 } , { 283 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P6" ) , 0 , 8 , 0 } , { 284 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P7" ) , 0 , 0 , 0 } , { 285 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P8" ) , 0 , 9 , 0 } , { 286 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P10" ) , 0 , 0 , 0 } , { 287 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P11" ) , 0 , 0 , 0 } , { 288 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P13" ) , 0 , 0 , 0 } , { 289 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P14" ) , 0 , 0 , 0 } , { 290 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P16" ) , 0 , 0 , 0 } , { 291 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P17" ) , 0 , 0 , 0 } , { 292 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P18" ) , 0 , 0 , 0 } , { 293 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P19" ) , 0 , 0 , 0 } , { 294 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P20" ) , 0 , 10 , 0 } , { 295 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P21" ) , 0 , 10 , 0 } , { 296 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P22" ) , 0 , 2 , 0 } , { 297 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P23" ) , 0 , 10 , 0 } , { 298 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/State-Space" ) , TARGET_STRING (
"P24" ) , 0 , 0 , 0 } , { 299 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/Unit Delay" ) , TARGET_STRING (
"InitialCondition" ) , 0 , 0 , 0 } , { 300 , TARGET_STRING (
"fast_powertrain/Battery/Model/Aging Model/it init3" ) , TARGET_STRING (
"InitialCondition" ) , 0 , 0 , 0 } , { 301 , TARGET_STRING (
...
TARGET_STRING ( "gainval" ) , 0 , 0 , 0 } , { 308 , TARGET_STRING (
"fast_powertrain/Battery/Model/Exp/Discrete-Time Integrator" ) ,
TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 309 , TARGET_STRING (
"fast_powertrain/Battery/Model/Exp/Gain1" ) , TARGET_STRING ( "Gain" ) , 0 ,
0 , 0 } , { 310 , TARGET_STRING ( "fast_powertrain/Battery/Model/Exp/Gain4" )
, TARGET_STRING ( "Gain" ) , 0 , 0 , 0 } , { 311 , TARGET_STRING (
...
TARGET_STRING ( "gainval" ) , 0 , 0 , 0 } , { 316 , TARGET_STRING (
"fast_powertrain/Supercapacitor1/Model/Discrete/Discrete-Time Integrator" ) ,
TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 317 , TARGET_STRING (
"fast_powertrain/powergui1/EquivalentModel1/Sources/SwitchCurrents" ) ,
...
) , TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 321 ,
TARGET_STRING (
...
) , TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 323 ,
TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/Aging factor Calculation Block/Memory3"
) , TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 324 ,
TARGET_STRING (
...
) , TARGET_STRING ( "UpperLimit" ) , 0 , 0 , 0 } , { 327 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/Aging factor Calculation Block/Saturation1"
) , TARGET_STRING ( "LowerLimit" ) , 0 , 0 , 0 } , { 328 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/Aging factor Calculation Block/Saturation2"
) , TARGET_STRING ( "UpperLimit" ) , 0 , 0 , 0 } , { 329 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/Aging factor Calculation Block/Saturation2"
) , TARGET_STRING ( "LowerLimit" ) , 0 , 0 , 0 } , { 330 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/Max. Number of Cycles Calculation Block/Saturation"
) , TARGET_STRING ( "UpperLimit" ) , 0 , 0 , 0 } , { 331 , TARGET_STRING (
 "fast_powertrain/Battery/Model/Aging Model/Max. Number of Cycles Calculation Block/Saturation"
) , TARGET_STRING ( "LowerLimit" ) , 0 , 0 , 0 } , { 332 , TARGET_STRING (
...
TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 337 , TARGET_STRING (
"fast_powertrain/Battery/Model/Aging Model/Subsystem/Memory1" ) ,
TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 338 , TARGET_STRING (
"fast_powertrain/Battery/Model/Aging Model/Subsystem/Memory10" ) ,
TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 339 , TARGET_STRING (
"fast_powertrain/Battery/Model/Aging Model/Subsystem/Memory11" ) ,
TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 340 , TARGET_STRING (
"fast_powertrain/Battery/Model/Aging Model/Subsystem/Memory12" ) ,
TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 341 , TARGET_STRING (
"fast_powertrain/Battery/Model/Aging Model/Subsystem/Memory13" ) ,
TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 342 , TARGET_STRING (
"fast_powertrain/Battery/Model/Aging Model/Subsystem/Memory14" ) ,
TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 343 , TARGET_STRING (
"fast_powertrain/Battery/Model/Aging Model/Subsystem/Memory15" ) ,
TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 344 , TARGET_STRING (
"fast_powertrain/Battery/Model/Aging Model/Subsystem/Memory16" ) ,
TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 345 , TARGET_STRING (
"fast_powertrain/Battery/Model/Aging Model/Subsystem/Memory17" ) ,
TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 346 , TARGET_STRING (
...
) , TARGET_STRING ( "const" ) , 0 , 0 , 0 } , { 355 , TARGET_STRING (
...
) , TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 365 ,
TARGET_STRING (
 "fast_powertrain/Supercapacitor1/Model/Discrete/Self_discharge Model/Unit Delay2"
) , TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 366 ,
TARGET_STRING (
...
static const rtwCAPI_ModelParameters rtModelParameters [ ] = { { 370 ,
TARGET_STRING ( "t" ) , 0 , 11 , 0 } , { 371 , TARGET_STRING ( "w" ) , 0 , 11
, 0 } , { 0 , ( NULL ) , 0 , 0 , 0 } } ;
#ifndef HOST_CAPI_BUILD
static void * rtDataAddrMap [ ] = { & rtB . mnnico2kpm , & rtB . nkylddyjyp ,
& rtB . gpw42pjoku , & rtB . aqkf223m44 , & rtB . aljtveo2dl , & rtB .
jr2i1iijlv , & rtB . pkp0sjqqg3 , & rtB . b11tooymbq , & rtB . in3foousin , &
rtB . pu2uj4duj0 , & rtB . bsiskimpq4 , & rtB . npdclyuhqf , & rtB .
e2chijmfh2 , & rtB . ajuoykrpve , & rtB . i0ujncnh35 , & rtB . bnsiwqbz4c , &
rtB . ktal25amyn , & rtB . glbb5pdj1b , & rtB . i5qlxhsaeo , & rtB .
cataaai4vr , & rtB . dplapzekhr , & rtB . nd5vhw3hdp , & rtB . hejghjylpf , &
rtB . lkdpawgj3d , & rtB . evwgggutgq , & rtB . k4spxtemch , & rtB .
nh1zxcsjip , & rtB . b2m0nyy1iq , & rtB . pkslvtv3r5 , & rtB . b0ihg4ev5s , &
rtB . pmkgps0zyu , & rtB . crs0im5dqp , & rtB . cp1s511zvk , & rtB .
mdng4h4wi3 , & rtB . k04sqjkmui , & rtB . nzprtrw2gw , & rtB . nfrcslok3r , &
rtB . bp13llqzit , & rtB . jqk43gypqg , & rtB . ju3eqofxsv , & rtB .
lwbnk1tqoe , & rtB . lnggl4hxqa , & rtB . cnvh3z11oj , & rtB . caydqvbppv , &
rtB . kx2yvfrvbs , & rtB . gvxuq2ivcx , & rtB . oaypl0xy40 , & rtB .
pd50rghzbf , & rtB . bbivpaarxt , & rtB . i4u1u0nk00 , & rtB . dg1zqpobap , &
rtB . iuiyd4knlc , & rtB . nw10mpmiwb , & rtB . dsv2bbs0k1 , & rtB .
ds4vmpgjgq [ 0 ] , & rtB . aprtxoz0cz [ 0 ] , & rtB . dsl30exhdf , & rtB .
aunoa00r4h , & rtB . akgc550kdx , & rtB . orc5wcdxm1 , & rtB . akwd4yohpb , &
rtB . hwgkbedju4 , & rtB . akgbctleuf , & rtB . fjva4ba3yf , & rtB .
ojpp3hq5ld , & rtB . ddwaerj1qf , & rtB . e4esbiadth , & rtB . dv32o2egzr , &
rtB . b1fl12txsf , & rtB . liwqgy4ofb , & rtB . cf3awerlht , & rtB .
o0lhjiunqy , & rtB . i4esmxfcaq , & rtB . ewvuxv0roa , & rtB . frtehkabsr , &
rtB . paaipnyjy4 , & rtB . ctjnl3duhv , & rtB . gswcpufwfm , & rtB .
klfwarvagc , & rtB . ftivrztnav , & rtB . ee4dkbgmbt , & rtB . oaxo1bryj0 [ 0
] , & rtB . h0hkib4ron , & rtB . gxs3xlh0jb , & rtB . cuh2ly0avr , & rtB .
aoywj0c0aw , & rtB . jpdjo1yg5c , & rtB . dn4cfjoyu3 , & rtB . d2aecp5kgr , &
rtB . a3xn5q0qbv , & rtB . m2zun0bmq0 , & rtB . nvvl1et5cw , & rtP .
Battery_BatType , & rtP . Battery_SOC , & rtP .
...
DiscretePIController2_Ki_lu2imaebpa , & rtP .
DiscretePIController2_Init_ofcbucrrnd , & rtP . PVMODULE1_Npar , & rtP .
PVMODULE1_Nser , & rtP . PVMODULE1_Ncell , & rtP . PVMODULE1_Voc , & rtP .
PVMODULE1_Isc , & rtP . PVMODULE1_Vmpp , & rtP . PVMODULE1_Impp , & rtP .
PVMODULE1_beta_Voc , & rtP . PVMODULE1_I0 , & rtP . PVMODULE1_df , & rtP .
PVMODULE1_Rsh , & rtP . PVMODULE1_Rs , & rtP . VariableResistor_Rabsmin , &
rtP . Constant_Value_embijewti4 , & rtP . Constant1_Value_f3txfozlof , & rtP
. Constant10_Value , & rtP . Constant2_Value_d2yksltlle , & rtP .
Constant3_Value_cnmqtz2p2n , & rtP . Constant4_Value_chdfctpggi , & rtP .
Constant6_Value , & rtP . Constant7_Value , & rtP .
Constant8_Value_iqk3wb1evy , & rtP . Constant9_Value_b1nk1ggw4w , & rtP .
Multiply_Gain_ghq4r0q5k3 , & rtP . Multiply1_Gain , & rtP . Multiply2_Gain ,
& rtP . Multiply3_Gain , & rtP . Ta_Value , & rtP . DiscretePIController1_Kp
, & rtP . DiscretePIController1_Ki , & rtP . DiscretePIController1_Init , &
rtP . DiscretePIController2_Kp_jtir0rv5nd , & rtP . DiscretePIController2_Ki
, & rtP . DiscretePIController2_Init , & rtP . DiscretePIController3_Kp , &
rtP . DiscretePIController3_Ki , & rtP . DiscretePIController3_Init , & rtP .
DiscretePIController4_Kp , & rtP . DiscretePIController4_Ki , & rtP .
DiscretePIController4_Init , & rtP . Constant_Value_ffncqspxq4 , & rtP .
Constant1_Value , & rtP . Constant2_Value , & rtP . Constant3_Value , & rtP .
Multiply_Gain_dppzkzoubi , & rtP . Saturation_UpperSat_jsjpgzsi1y , & rtP .
Saturation_LowerSat_ebjhnxsenp , & rtP . Saturation1_UpperSat , & rtP .
Saturation1_LowerSat , & rtP . Saturation2_UpperSat_amgcitvjo2 , & rtP .
Saturation2_LowerSat_lkim1nsn2b , & rtP . Saturation3_UpperSat , & rtP .
...
Saturation7_LowerSat , & rtP . UnitDelay1_InitialCondition , & rtP .
UnitDelay2_InitialCondition_mynahauzpq , & rtP .
Saturation1_UpperSat_jbsy2jdb2e , & rtP . Saturation1_LowerSat_km3pw1r5au , &
rtP . UnitDelay1_InitialCondition_gagfd2xjhh , & rtP .
...
donotdeletethisgain_Gain_ebxbsb35rt , & rtP .
DiscreteTimeIntegrator_gainval_jv55x3tqio , & rtP .
DiscreteTimeIntegrator_UpperSat_n2g2yvldpg , & rtP .
DiscreteTimeIntegrator_LowerSat_fv0zcc4hsa , & rtP .
Saturation2_UpperSat_hr00iu210k , & rtP . Saturation2_LowerSat_kq0ryizxeu , &
rtP . OutputSamplePoints_Value [ 0 ] , & rtP . Constant_Value_kfm5xzok4i , &
rtP . DiscreteTimeIntegrator_gainval_m4ai2wnufy , & rtP .
DiscreteTimeIntegrator_IC_bjhalm0xhc , & rtP . Multiply_Gain , & rtP .
Saturation_UpperSat_gvrgxklgqx , & rtP . Saturation_LowerSat_cndq0w2uve , &
...
Constant14_Value , & rtP . Constant8_Value , & rtP . Constant9_Value , & rtP
. inti_gainval , & rtP . inti_UpperSat , & rtP . inti_LowerSat , & rtP .
Gain_Gain , & rtP . Gain2_Gain , & rtP . R1_Gain , & rtP . R2_Gain , & rtP .
R3_Gain , & rtP . R4_Gain , & rtP . Memory_InitialCondition , & rtP .
Memory2_InitialCondition , & rtP . itinit_InitialCondition , & rtP .
itinit1_InitialCondition , & rtP . Saturation_UpperSat_ms3dxtbvew , & rtP .
Saturation_LowerSat_p3nlfvz151 , & rtP . Currentfilter5_NumCoef , & rtP .
Currentfilter5_DenCoef [ 0 ] , & rtP . Currentfilter5_InitialStates , & rtP .
donotdeletethisgain_Gain , & rtP . donotdeletethisgain_Gain_kzwtp4lcwh , &
rtP . donotdeletethisgain_Gain_jjlpkzumz0 , & rtP .
...
Constant3_Value_nmyyw0epx1 , & rtP . Constant4_Value , & rtP .
...
13 , 1 , 1 , 3 , 1 , 12 , 1 , 180720 } ; static const real_T
rtcapiStoredFloats [ ] = { 0.0 , 0.001 , 0.01 } ; static const
...
rtwCAPI_ModelMappingStaticInfo mmiStatic = { { rtBlockSignals , 92 ,
rtRootInputs , 0 , rtRootOutputs , 0 } , { rtBlockParameters , 278 ,
rtModelParameters , 2 } , { ( NULL ) , 0 } , { rtDataTypeMap , rtDimensionMap
, rtFixPtMap , rtElementMap , rtSampleTimeMap , rtDimensionArray } , "float"
, { 128974220U , 3459481193U , 3351760960U , 1013255462U } , ( NULL ) , 0 , 0
} ; const rtwCAPI_ModelMappingStaticInfo * fast_powertrain_GetCAPIStaticMap (
